...
🏟️ **[Sports Booking System](https://github.com/pranavk-t/sports-booking-system)** | Backend service for sports venue and time-slot booking with conflict prevention. Implemented slot availability checks, booking/cancellation workflows, and transactional consistency. | Spring Boot • Spring Data JPA • MySQL • REST APIs • Docker |
